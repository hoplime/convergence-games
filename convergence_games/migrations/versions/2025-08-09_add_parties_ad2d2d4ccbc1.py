...
def schema_upgrades() -> None:
    ...
    with op.batch_alter_table("party_user_link", schema=None) as batch_op:
        batch_op.create_index(
            "ix_unique_party_leader", ["party_id"], unique=True, postgresql_where=sa.text("is_leader = true")
        )

    with op.batch_alter_table("game_content_warning_link", schema=None) as batch_op:
        batch_op.create_unique_constraint(
            batch_op.f("uq_game_content_warning_link_game_id"), ["game_id", "content_warning_id"]
        )
